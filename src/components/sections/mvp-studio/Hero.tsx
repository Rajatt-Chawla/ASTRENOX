      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              MVP Studio
              <span className="block gradient-text">Ship in 4–8 weeks, fixed scope</span>
            </motion.h1>
            ...
            >
              A packaged sprint to design, build, and ship your AI-first MVP with ruthless 
              prioritization, daily progress, and a live demo every Friday.
            </motion.p>
              ...
              <div className="bg-surface-card border border-border-soft rounded-xl p-8 shadow-card hover:shadow-float transition-all duration-med hover:-translate-y-2">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-xs text-text-muted">MVP Timeline</div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-text-muted mt-1">Week 1-2: Design & Setup</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-text-muted mt-1">Week 3-6: Development</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-text-muted mt-1">Week 7-8: Launch</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-bg-base rounded-lg p-4 border border-border-soft">
                    <div className="text-xs text-accent-secondary font-mono">
                      <div className="text-info">const</div> mvp = {'{'}
                      <div className="ml-4">
                        <div>timeline: <span className="text-success">"4-8 weeks"</span>,</div>
                        <div>scope: <span className="text-warning">"Fixed"</span>,</div>
                        <div>outcome: <span className="text-accent-primary">"Live Product"</span></div>
                      </div>
                      {'}'};
                    </div>
                  </div>
