      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Production-ready AI automations that plug into your tools, data, and teams. 
              We build intelligent workflows that work seamlessly with your existing infrastructure 
              and deliver measurable business impact from day one.
            </motion.p>
              ...
              <div className="bg-surface-card border border-border-soft rounded-xl p-8 shadow-card hover:shadow-float transition-all duration-med hover:-translate-y-2">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-xs text-text-muted">AI Automations</div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-text-muted mt-1">AI Chatbots & Assistants</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-text-muted mt-1">Workflow Automations</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-text-muted mt-1">Knowledge Search</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-bg-base rounded-lg p-4 border border-border-soft">
                    <div className="text-xs text-accent-secondary font-mono">
                      <div className="text-info">const</div> automation = {'{'}
                      <div className="ml-4">
                        <div>type: <span className="text-success">"Production-Ready"</span>,</div>
                        <div>integration: <span className="text-warning">"Seamless"</span>,</div>
                        <div>impact: <span className="text-accent-primary">"Measurable"</span></div>
                      </div>
                      {'}'};
                    </div>
                  </div>
