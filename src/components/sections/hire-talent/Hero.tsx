      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Hire elite AI & engineering talent, on-demand
            </motion.h1>
            ...
            >
              Ship faster with pre-vetted builders, fractional leaders, and outcome-driven squads 
              that plug into your roadmap from day one.
            </motion.p>
              ...
              <div className="bg-surface-card border border-border-soft rounded-xl p-8 shadow-card hover:shadow-float transition-all duration-med hover:-translate-y-2">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-xs text-text-muted">Talent Pipeline</div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-text-muted mt-1">AI Engineers</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-text-muted mt-1">Data Scientists</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-text-muted mt-1">Product Managers</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-bg-base rounded-lg p-4 border border-border-soft">
                    <div className="text-xs text-accent-secondary font-mono">
                      <div className="text-info">const</div> talent = {'{'}
                      <div className="ml-4">
                        <div>quality: <span className="text-success">"Elite"</span>,</div>
                        <div>speed: <span className="text-warning">"On-Demand"</span>,</div>
                        <div>outcome: <span className="text-accent-primary">"Measurable"</span></div>
                      </div>
                      {'}'};
                    </div>
                  </div>
