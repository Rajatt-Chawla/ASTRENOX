        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-bg-base p-8 md:p-12 rounded-2xl border border-border-subtle">
            <p className="text-xl md:text-2xl text-text-primary text-center leading-relaxed mb-6">
              To democratize AI and make advanced technology accessible to businesses of all sizes, 
              enabling them to innovate, scale, and thrive in the digital age.
            </p>
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <div className="text-center">
                ...
                <p className="text-text-secondary">Pushing boundaries with cutting-edge AI solutions</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-text-secondary">Building trust through transparency and excellence</p>
              </div>
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-text-primary mb-2">Partnership</h3>
                <p className="text-text-secondary">Growing together with our clients' success</p>
              </div>
            </div>
          </div>
        </div>
