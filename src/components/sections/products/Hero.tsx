      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              AI Products That
              <span className="block gradient-text">Transform Business</span>
            </motion.h1>
            ...
            >
              Our flagship products combine cutting-edge AI technology with enterprise-grade 
              reliability to deliver measurable business impact across your organization.
            </motion.p>
              ...
              <div className="bg-surface-card border border-border-soft rounded-xl p-8 shadow-card hover:shadow-float transition-all duration-med hover:-translate-y-2">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-xs text-text-muted">Astrenox Products</div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-text-muted mt-1">ANX Intelligence</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-text-muted mt-1">Engine v</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-bg-base rounded-lg p-4 border border-border-soft">
                    <div className="text-xs text-accent-secondary font-mono">
                      <div className="text-info">const</div> products = {'{'}
                      <div className="ml-4">
                        <div>anx: <span className="text-success">"Business Copilot"</span>,</div>
                        <div>engine: <span className="text-warning">"AI Platform"</span>,</div>
                        <div>impact: <span className="text-accent-primary">"Transformative"</span></div>
                      </div>
                      {'}'};
                    </div>
                  </div>
